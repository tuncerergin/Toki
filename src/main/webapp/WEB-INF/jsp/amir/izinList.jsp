...
<div class="wrapper">
    <div class="header">
        <h2 class="text-center p-3 mb-2 bg-success text-white">Amir page</h2>
    </div>
</div>
<div class="container">
    <div class="row">
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${izin.onay=='b'}">
                                ...
                                <a href="${onaylaLink}" class="badge badge-warning">
                                ...
                                <a href="${redLink}" class="badge badge-danger"
                            ...
                            <c:otherwise>
                                <a href='javascript: void(0);' class="badge badge-secondary disabled"
